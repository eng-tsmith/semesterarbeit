...
class IAM_Predictor(PredictorTask):
    ...
    def train_rnn(self, inputs):
        ...
        # self.model.train_on_batch(self, x=inputs[0], y=inputs[1], class_weight=None, sample_weight=None)  #TODO metrics?
    ...
    def test_rnn(self, inputs):
        ...
        """
        print('Test...')
        self.model.test_on_batch(self, x=inputs[0], y=inputs[1], sample_weight=None)  #TODO metrics?
